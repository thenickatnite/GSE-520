...
coeftest(modiv)
```
I did not witness a large change in the estimate of education on number of kids. The estimate is still significant, and is now slightly more negative. Not a real big change from the initial $educ$ variable and the instruments $meduc$ and $feduc$.
