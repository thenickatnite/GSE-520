...
```
Plot the graph and then interpret what you see. Is there a clear discontinuity following the policy implementation? What are the implications if a clear discontinuity does not appear graphically?
...
>
>If there appears to be no discontinuity grpahically, a researcher will likely need to revaluate their method, as their research question may not fit a RD design. Or find a new cutoff point, or variable to model the discontinuity.
