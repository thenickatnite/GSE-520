...
SE_hat_1 = sqrt((e_e / n- 3) * solve(X[2,2]))
SE_hat_2 = sqrt((e_e / n- 3) * solve(X[3,3]))
...
CI_beta1 = beta1_hat + c(-1,1)*CV*SE_hat_1
CI_beta1
CI_beta2 = beta2_hat + c(-1,1)*CV*SE_hat_2
CI_beta2
```
...
mod$coefficients
#linearHypothesis(mod, 'lsat = -rank')
```
