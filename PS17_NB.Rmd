...
```
>
Now the $app\_funds\_pc50$ is significant at the $5\%$ significance level (when using the instrumental variable of $yrsexposure\_UR$). Adjusting for all other variables, a 1 unit increase in urban renewal funds per capita ($100) in 1950 is associated with an average increase of 2.4% in median familly income in 1980.
