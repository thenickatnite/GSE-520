...
= & x_o' E(\beta) + E(\varepsilon_o) - x_o'E(b) \\
= & x_o' \beta + \sigma^2 - x_o' \beta \\
= & \sigma^2 \\
\end{align*}

\begin{align*}
Var(y_o - \hat{y}_o) = & Var(x_o' \beta + \varepsilon_o - x_o'b) \\
= & Var(x_o' \beta) + Var(\varepsilon_o) - Var(x_o' b) \\
= & Var(x_o' \beta) - Var(x_o' b) + \sigma^2 \\
= & x_o' Var(\beta) - x_o' Var(b) + \sigma^2 \\
= & x_o' \widehat{Var(b)}x_o + \sigma^2 \\
\end{align*}
